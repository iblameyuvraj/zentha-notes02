...
export default function UploadedContentChemistry() {
  ...
  const fetchUploads = async () => {
    ...
    try {
      ...
      if (result.success) {
        // Filter for chemistry-related subjects only
        const chemistryUploads = result.data.filter((upload: UploadedContent) => 
          chemistrySubjects.includes(upload.subject) || 
          (upload.subject_combo && upload.subject_combo !== "Physics and PPS")
        )
        setUploads(chemistryUploads)
      } else {
  ...
  // Get unique values for filters (only from chemistry-related uploads)
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-2 text-gray-600 dark:text-gray-300">Loading chemistry uploads...</span>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white dark:text-gray-100 mb-2">Chemistry Teacher Uploads</h1>
        <p className="text-gray-600 dark:text-gray-300">Access chemistry-related notes and assignments uploaded by teachers</p>
      </div>
      ...
      <div className="mb-4">
        <p className="text-gray-600 dark:text-gray-300">
          Showing {sortedUploads.length} chemistry-related documents
        </p>
      </div>
      ...
      {sortedUploads.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No chemistry uploads found</h3>
